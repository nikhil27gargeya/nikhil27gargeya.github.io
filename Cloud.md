...
Topics: cloud computing fundamentals, IaaS, PaaS, SaaS, public cloud, private cloud, hybrid cloud, multicloud, regions, availability zones, virtual machines, containers, serverless computing, cloud storage, object storage, block storage, file storage, managed databases, virtual private clouds, subnets, routing, security groups, firewalls, cloud load balancers, identity and access management, secrets management, autoscaling, infrastructure as code, Terraform, CI/CD in the cloud, Kubernetes, container orchestration, cloud monitoring, cloud logging, backups, disaster recovery, high availability, cloud cost management, AWS, Azure, GCP
